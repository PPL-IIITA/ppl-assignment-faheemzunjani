#ifndef GENERIC_GIRL_H
#define GENERIC_GIRL_H
#include <string>

namespace data {
    //! Generic Girl class 
    /*!
        Generic Girl class which contains attributes to describe a Generic girl and is used as a super class. 
    */
    class generic_girl {
        protected:
        ...
        public:
            ...
            */
            generic_girl(std::string name_id, int attractiveness, 
            ...
            */
            ...
            //! Change commit type Mutator
            /*!
              \param type New Type of the girl.
            */
